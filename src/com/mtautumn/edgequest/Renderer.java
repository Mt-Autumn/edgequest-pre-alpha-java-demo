...
public class Renderer extends JComponent {
	...
	public void paint (Graphics g) {
		...
		if (getCharaterBlockInfo()[0] == blockInfo.getBlockID("water") && getCharaterBlockInfo()[1] == 0.0) {
				g2.drawImage(textureManager.getTexture(blockInfo.getBlockID("waterSplash"), sceneManager), (int) ((sceneManager.screenWidth- sceneManager.blockSize) / 2.0), (int) ((sceneManager.screenHeight - sceneManager.blockSize) / 2.0), sceneManager.blockSize, sceneManager.blockSize, null);
		}
